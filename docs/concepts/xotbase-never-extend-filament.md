...
type: concept
module: AI
tags: [ai, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "AI filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/AI` estende una classe `Filament\...` direttamente.
