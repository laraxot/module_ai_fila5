---
title: "On-Demand Pattern — Module AI"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
| Ricerca locale | `qmd search "topic" -c AI` |
| Wiki locale | `Read ./laravel/Modules/AI/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/AI/docs/wiki/log.md
