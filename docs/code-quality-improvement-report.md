---
title: "Code Quality Improvement Report — AI"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "AI"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot AI"
story: STORY-001
issues:
...
# Code Quality Improvement Report — AI
...
| Indicatore | Valore |
|---|---:|
| File PHP applicativi/database/route | 22 |
| File di test PHP | 8 |
| Rapporto test/file PHP | 36% |
| Candidati senza strict types | 21 |
...
1. **database/seeders/AIDatabaseSeeder.php — strict types e firme.** Inserire declare(strict_types=1) subito dopo l’apertura PHP; eseguire PHPStan e sostituire i tipi impliciti o mixed emersi con tipi concreti. Verifica: PHPStan scoped e test che esercita la prima API pubblica del file.
...
Dalla cartella laravel/:
    ...
    ./vendor/bin/phpstan analyse Modules/AI --memory-limit=-1
