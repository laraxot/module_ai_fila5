---
title: "AI Module - PHPStan Type Compliance"
type: concept
tags: [ai, phpstan, types, compliance, quality, static-analysis]
created: 2026-06-10
updated: 2026-06-10
related:
...
# AI Module — PHPStan Type Compliance
...
```bash
vendor/bin/phpstan analyse laravel/Modules/AI \
  --level=max \
  --no-progress
```
...
```bash
vendor/bin/phpstan analyse laravel/Modules/AI --level=max
```
...
# Verbose mode
vendor/bin/phpstan analyse laravel/Modules/AI --level=max -v
```
...
```bash
vendor/bin/pest laravel/Modules/AI/tests --parallel
```
