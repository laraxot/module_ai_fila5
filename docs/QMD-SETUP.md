...
paths:
  include:
    ...
    - ./laravel/Modules/AI/docs/wiki/**/*.md  # ← Questo modulo
```
...
```bash
qmd search "<topic>" -c AI
# Cerca solo in ./laravel/Modules/AI/docs/wiki/
```
...
```bash
qmd search "form" -c AI   # Solo questo modulo
```
