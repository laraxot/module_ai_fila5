...
- File in `app/`: 19
- File di test: 8 — rapporto test/app: 42%
...
- Modules/AI/app/Actions/Predict/GeneratePredictionDraftsAction.php:124                             CyclomaticComplexity      The method parseDrafts() has a Cyclomatic Complexity of 10. The configured cyclomatic complexity threshold is 10.
...
**Esempio concreto** — `Modules/AI/app/Actions/GeneratePredictionsAction.php`:
